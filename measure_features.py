...
img_path = "resized_data/test_image_resized/"
seg_path = "resized_data/test_segmentation_resized/"

if __name__ == "__main__":
    # Read the example ground thruth csv to get image ids and melanoma data
    df = pd.read_csv("data/test_ground_truth.csv")[["image_id", "melanoma"]]
    ...
    df.astype(types)
    df.to_csv("features/features_test.csv", index=False)
